...
ARG VITE_AUTH_SUPABASE_URL
ARG VITE_AUTH_SUPABASE_ANON_KEY

ENV VITE_SISUB_SUPABASE_URL=$VITE_SISUB_SUPABASE_URL \
    VITE_SISUB_SUPABASE_ANON_KEY=$VITE_SISUB_SUPABASE_ANON_KEY \
    VITE_AUTH_SUPABASE_URL=$VITE_AUTH_SUPABASE_URL \
    VITE_AUTH_SUPABASE_ANON_KEY=$VITE_AUTH_SUPABASE_ANON_KEY
WORKDIR /repo
