...
describe("expandHome", () => {
	...
	it("nunca devolve caminho relativo para um valor com til — este é o ponto", () => {
		// O `.env.schema` documenta `~/rada-e`, e o shell NÃO expande valor lido de arquivo.
		// Sem a expansão, o acervo caía em `apps/alpha/~/rada-e/`, dentro da árvore de um
		// repositório público e fora de qualquer regra do .gitignore.
