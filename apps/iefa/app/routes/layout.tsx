...
function UserMenu() {
    ...
    if (isLoading) {
        return <div className="h-8 w-8 rounded-lg bg-muted animate-pulse" aria-hidden="true" />;
    }
        ...
        >
            ...
            <footer className="border-t">
                <div className={`${container} h-14 flex items-center justify-center text-xs text-muted-foreground`}>
                    © {new Date().getFullYear()} IEFA. <b>Desenvolvido por Ten Nanni (IEFA)</b>. Alguns serviços são
