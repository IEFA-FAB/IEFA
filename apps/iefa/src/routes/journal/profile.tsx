		...
		<div className="container mx-auto max-w-4xl px-4 py-8">
			<div className="mb-8">
				...
				<p className="mt-2 text-muted-foreground">
					Gerencie suas informações pessoais e preferências do sistema de
					publicações.
				</p>
			</div>
			...
			<div className="mt-6 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-900 dark:bg-blue-950">
				...
				<p className="mt-2 text-sm text-blue-800 dark:text-blue-200">
					As informações preenchidas aqui serão utilizadas automaticamente ao
					submeter artigos. Certifique-se de manter seus dados atualizados,
					especialmente seu ORCID e afiliação institucional.
				</p>
			</div>
		</div>
	);
