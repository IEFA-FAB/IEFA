...
const serverEnvSchema = z.object({
	...
	// infra/contrate). O client SSR de auth usa ESTA, não a service key: getUser()
...
if (!parsed.success) {
	...
	throw new Error(`[contrate] Missing or invalid server environment variables: ${missing}`)
}
