...
export const Route = createRootRouteWithContext<MyRouterContext>()({
	...
	head: () => {
		...
		const description = "Copiloto de aquisições da FAB — verificação de ETP e TR contra a Lei 14.133/21 e apoio ao pregão."
		const title = "Contrate — IEFA"
		return {
			meta: [
				{ charSet: "utf-8" },
				...
				{ property: "og:site_name", content: "Contrate" },
