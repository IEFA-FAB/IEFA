# STYLE CONTRACT — Contrate (herdado do Portal IEFA)

> O `contrate` adota o Pale Brutalism do portal sem variação. Este arquivo é cópia do
> `apps/portal/STYLE_CONTRACT.md`: mudança de sistema visual se faz nos DOIS.
