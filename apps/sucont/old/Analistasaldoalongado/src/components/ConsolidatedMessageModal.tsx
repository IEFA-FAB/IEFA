...
export const ConsolidatedMessageModal: React.FC<ConsolidatedMessageModalProps> = ({ data, racFilter, onClose }) => {
...
Divisão de Acompanhamento Contábil e de Suporte ao Usuário – SUCONT-3`
	}, [data, racFilter, messageNumber, messageDate, messageType, deadlineDate, formatToMilitaryDate, formatToBrazilianDate])
					...
					<div className="w-full md:w-[350px] flex flex-col bg-white shrink-0 border-r border-slate-200 overflow-y-auto">
						...
						<div className="p-4 space-y-4">
							...
							<div className="pt-4">
								<button
									onClick={handleCopy}
									className="w-full flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-white bg-fab-600 border border-transparent rounded-lg hover:bg-fab-700 transition-colors focus:outline-none focus:ring-2 focus:ring-fab-500 focus:ring-offset-1 shadow-sm"
								>
									{copied ? (
										<>
