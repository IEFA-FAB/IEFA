import { BookOpen, ChevronDown, ChevronUp, Map, Plane, RefreshCw } from "lucide-react"
import { useState } from "react"
import { FileUpload } from "./components/FileUpload"
import { Report } from "./components/Report"
import { analyzeData, parseFile, type ReportData } from "./utils/analyzer"
...
export default function App() {
	...
	return (
		<div className="min-h-screen bg-slate-50 font-sans text-slate-900">
			{/* HEADER FAB / DIREF */}
			<header className="bg-[#0033A0] text-white shadow-md border-b-4 border-amber-400 sticky top-0 z-10">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex items-center justify-between">
					<div className="flex items-center gap-5">
						...
						<div>
							<div className="text-xs font-bold text-amber-400 tracking-widest uppercase mb-1 drop-shadow-sm">
								Comando da Aeronáutica • Diretoria de Economia e Finanças
							</div>
							<h1 className="text-2xl font-extrabold tracking-tight flex items-center gap-2">
								Analista SUCONT
								<span className="text-blue-200 font-medium text-lg ml-2 border-l border-blue-400/50 pl-3">
									Cruzamento de Contas Correntes de Cobrança (Q43)
								</span>
							</h1>
						</div>
					</div>
					{reportData && (
						<button
							onClick={handleReset}
							className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 text-sm font-bold uppercase tracking-wider rounded-lg transition-colors border border-white/20"
						>
						...
						<div className="w-full max-w-2xl mb-10 space-y-4">
							...
							<div className="bg-blue-50 border-l-4 border-[#0033A0] p-5 rounded-r-xl shadow-sm text-left">
								...
								<p className="text-sm text-blue-900 font-medium leading-relaxed">
									<span className="font-bold">Questão 43</span> - Os saldos da conta EM COBRANÇA - A RECEBER (8.9.7.1.1.03.00), registrados na UG, são
									compatíveis com os saldos registrados na conta EM COBRANÇA (8.9.7.2.1.03.00) registrados na SDPP-País?
								</p>
							</div>
									...
									<div className="p-6 border-t border-slate-200 space-y-6 text-sm text-slate-700 leading-relaxed">
										...
										<div className="bg-slate-50 p-4 rounded-lg border border-slate-200 space-y-4 mb-6">
											<div>
												...
												<p className="text-slate-600">
													Verificar a conformidade e o espelhamento entre contas contábeis correlatas, garantindo que os registros representem de forma
													fidedigna os fatos administrativos e a situação patrimonial do COMAER.
												</p>
											</div>
											<div>
										...
										<div>
											...
											<ul className="list-disc pl-5 space-y-1 text-slate-600">
												<li>
													<strong className="text-slate-700">Debitada:</strong> Pela apropriação da baixa com responsabilidade ou pelo encerramento do
													exercício.
												</li>
												<li>
										...
										<div>
											...
											<p className="mb-2">
												<strong>Função:</strong> Registra o montante da responsabilidade de terceiros por valores, títulos e bens em fase de cobrança pela
												Unidade Gestora.
											</p>
											<ul className="list-disc pl-5 space-y-1 text-slate-600">
												<li>
												...
												<li>
													<strong className="text-slate-700">Creditada:</strong> Pela apropriação da responsabilidade de terceiros ou pelos estornos efetuados
													com a negativação parcial ou total dos valores.
												</li>
											</ul>
										</div>
