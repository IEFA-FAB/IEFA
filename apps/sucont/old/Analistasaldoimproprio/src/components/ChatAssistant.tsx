...
interface ChatAssistantProps {
	...
	estrategicoData: {
		...
		topOrgaosSuperiores: { name: string; count: number; value: number; percent: number }[]
...
export const ChatAssistant: React.FC<ChatAssistantProps> = ({ managerialData, estrategicoData, decisaoData }) => {
	...
	const handleSearch = (e: React.FormEvent) => {
		...
		if (lowerQuery.includes("ods") && (lowerQuery.includes("mais inconsistências") || lowerQuery.includes("maior risco"))) {
			...
			if (decisaoData) {
				...
				response = `A análise de Pareto indica que uma parcela reduzida de UGs concentra a maioria das inconsistências. Carregue mais dados para um percentual exato.`
			}
