						...
						<tbody className="divide-y divide-border">
							{filteredAndSortedData.map((row) => (
								<tr key={row.ug} className="bg-card hover:bg-fab-50/50 transition-colors group">
									...
									<td className="px-5 py-3 text-muted-foreground">{getUgHierarchy(row.ug).orgaoSuperior}</td>
									<td className="px-5 py-3 text-muted-foreground">{getUgHierarchy(row.ug).ods}</td>
