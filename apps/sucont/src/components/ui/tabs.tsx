...
/**
 * Abas do sucont. Base UI, portado do sisub.
 *
 * Substitui os segmentos feitos com `<button>` nativo que existiam em quatro
 * ferramentas — cada um com sua própria altura, seu próprio estado ativo e sem
 * `role="tab"`. Nenhum deles navegava por seta do teclado.
 */
