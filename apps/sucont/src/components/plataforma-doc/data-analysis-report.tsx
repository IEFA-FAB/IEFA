...
export function DataAnalysisReport({ data }: DataAnalysisReportProps) {
	return (
		<div className="bg-card text-foreground shadow-2xl mx-auto my-8 p-[20mm] w-[210mm] min-h-[297mm] font-sans selection:bg-blue-100 print:shadow-none print:my-0 print:p-[15mm]">
			{/* Cabeçalho */}
					...
					return (
						<div key={idx} className="bg-muted/50 border border-border rounded-2xl p-6 transition-all hover:shadow-md flex flex-col min-h-[140px]">
							...
							<div className="flex items-start justify-between gap-3 mt-auto">
								...
								<div className={`p-2 rounded-full shrink-0 ${metric.trend === "up" ? "bg-success/10" : metric.trend === "down" ? "bg-rose-50" : "bg-muted"}`}>
