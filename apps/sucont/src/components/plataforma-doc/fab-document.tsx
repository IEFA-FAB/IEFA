...
export function FabDocument({ data, onChange }: FabDocumentProps) {
	const handleFieldChange = <K extends keyof FabDocumentData>(field: K, value: FabDocumentData[K]) => {
	...
	return (
		<div className="bg-card shadow-2xl mx-auto my-8 p-[2.5cm] w-[210mm] min-h-[297mm] text-black font-serif text-[12pt] leading-relaxed relative print:shadow-none print:my-0 print:p-[2cm]">
			...
			<div className="flex flex-col items-center text-center mb-10">
				<img src="/brasao-republica.svg" alt="Brasão da República" className="w-16 h-16 mb-4" referrerPolicy="no-referrer" />
			...
			<div className="mt-auto pt-12 flex flex-col items-center text-center">
				<div className="border-t border-black w-64 mb-4" />
