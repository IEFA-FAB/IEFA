...
CREATE TABLE public.grupo_produto (
  ...
  produto_pronto character varying,
  grupo_predescessor integer,
  CONSTRAINT grupo_produto_pkey PRIMARY KEY (id_grupo_produto),
  CONSTRAINT fk14440923929213db FOREIGN KEY (grupo_predescessor) REFERENCES public.grupo_produto(id_grupo_produto)
);
