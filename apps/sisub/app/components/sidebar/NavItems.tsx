...
import { FileText, type LucideIcon, Settings, ShieldCheck, UtensilsCrossed } from "lucide-react";
...
export function buildSidebarData({ level, activePath }: BuildSidebarDataParams): AppSidebarData {
