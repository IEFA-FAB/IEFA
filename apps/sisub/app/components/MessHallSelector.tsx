...
import { Label, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Badge } from "@iefa/ui";
...
export const MessHallSelector = memo<MessHallSelectorProps>(
    ({
        ...
        }, [baseTrigger, disabled, hasDefault, showValidation, selectorData.isValidSelection, value, size]);
