...
export const MealButton = memo<MealButtonProps>(({ meal, isSelected, onToggle, disabled, compact = false }) => {
    ...
    return (
        <button onClick={onToggle} disabled={disabled} className={buttonClasses}>
            <div className="flex items-center justify-between">
                ...
                <div
                    className={cn("flex items-center justify-center w-6 h-6 rounded-full transition-all duration-200", {
