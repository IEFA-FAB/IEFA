                    ...
                    <div className="w-full bg-muted/50 rounded-lg p-2 border border-border">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex space-x-1">
                                {[...Array(4)].map((t) => (
                                    <Skeleton key={t} className="w-2 h-2 rounded-full" />
                                ))}
                            </div>
                        </div>
                    </div>
...
export const DayCard = memo<DayCardProps>(
    ({
        ...
        }, [pendingChanges, date, daySelections, dayMessHallId, defaultMessHallId, selectedMealsCount]);
...
export const useDayCardData = (
    ...
    }, [date, todayString, isDateNear, formatDate, getDayOfWeek, daySelections, pendingChanges]);
};
