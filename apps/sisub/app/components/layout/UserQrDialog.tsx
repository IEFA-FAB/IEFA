        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            ...
            >
                <div className="bg-primary px-4 py-3 text-primary-foreground sm:px-6 sm:py-4">
                    <DialogHeader>
                        <DialogTitle id={titleId} className="flex items-center gap-2 text-lg font-bold sm:text-xl">
                            <span
                                aria-hidden="true"
                        ...
                        <DialogDescription id={descId} className="mt-1 text-sm text-primary-foreground/80 sm:mt-2">
