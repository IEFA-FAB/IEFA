...
import { Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle } from "@iefa/ui";
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[520px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Preencha todos os campos para cadastrar o usuário em profiles_admin. O ID deve ser o UUID do
                        usuário que se tornará Admin.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="grid gap-4 py-2">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Select value={role ?? ""} onValueChange={(value) => setRole(value as UserLevelOrNull)}>
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Select value={om || ""} onValueChange={(value) => setOm(value)} disabled={isLoadingUnits}>
                            <SelectTrigger className="col-span-3">
                                <SelectValue
                    ...
                    {unitsError && <p className="col-span-4 text-sm text-destructive">{unitsError}</p>}
                </div>
