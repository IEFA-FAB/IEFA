...
export function useUserLevel(
    userId: string | null | undefined,
    options?: Omit<UseQueryOptions<AdminProfile | null, Error, UserLevelOrNull>, "queryKey" | "queryFn" | "select">,
) {
...
export function useUserOm(
    userId: string | null | undefined,
    options?: Omit<UseQueryOptions<AdminProfile | null, Error, UserOm>, "queryKey" | "queryFn" | "select">,
) {
