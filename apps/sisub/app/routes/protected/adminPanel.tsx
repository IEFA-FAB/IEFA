...
export function meta() {
    return [{ title: "Painel Admin" }, { name: "description", content: "Controle sua unidade" }];
}
        ...
        <div className="min-h-screen ">
            ...
            >
                <div className="grid grid-cols-1 gap-6 lg:gap-8">
                    <IndicatorsCard />
                    <QRAutoCheckinCard selectedOm={selectedOm} onChangeSelectedOm={setSelectedOm} status={status} />
                </div>
            </section>
        </div>
    );
