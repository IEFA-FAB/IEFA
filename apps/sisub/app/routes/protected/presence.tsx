...
import { type DialogState, generateRestrictedDates, type MealKey } from "~/utils/FiscalUtils";
...
export default function Qr() {
    ...
    const getMessHallIdByCode = useCallback(async (code: string): Promise<number | undefined> => {
        ...
        <div className="pt-10 space-y-6 min-h-screen container mx-auto max-w-screen-2xl px-4">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-end gap-3">
                ...
                <div className="w-full sm:w-auto flex flex-wrap items-center gap-2 sm:justify-end">
                    ...
                    {lastScanResult && (
                        <Button variant="secondary" size="sm" onClick={actions.clearResult} className="shrink-0">
                            Limpar
                        </Button>
                    )}
