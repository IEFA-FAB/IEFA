...
function buildRedirectTo(pathname: string, search: string, fallback = "/rancho") {
    ...
    return (
        <div className="max-w-md mx-auto p-6 text-center space-y-6">
            ...
            <p className="text-sm text-muted-foreground">
                Unidade: <b>{unidade}</b> • Data: <b>{date}</b> • Refeição: <b>{meal}</b>
            </p>
            ...
            <div className="rounded-md border p-4 text-left space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    {uuid && <div className="text-xs text-muted-foreground mt-1">UUID: {uuid}</div>}
                </div>
            ...
            <div className="flex flex-col items-center justify-center gap-2">
                <div className="flex items-center justify-center gap-3">
                    <Button onClick={handleSubmit} disabled={!uuid || submitting || redirectCountdown !== null}>
