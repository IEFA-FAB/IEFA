    ...
    <div className="w-full">
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-primary/50 via-primary/20 to-primary/50" />
      ...
      >
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <div className="rounded-xl p-8 text-primary-foreground text-center shadow-lg ring-1 ring-inset ring-border/30 bg-gradient-to-r from-primary to-primary/85">
      ...
      <Appear id="cta" className="relative py-20" aria-labelledby="cta-heading">
        <div className="relative text-center max-w-3xl mx-auto rounded-2xl bg-gradient-to-r from-primary to-primary/85 text-primary-foreground shadow-lg ring-1 ring-inset ring-border/30 overflow-hidden p-10 px-20">
          <div
            aria-hidden
 ...
 * Simplificado e sem estado global.
 */
function Appear(props: {
  ...
  return (
    <Comp
      id={id}
      ref={ref}
      className={`${className} transition-all ${duration} ${delayClass} ${
