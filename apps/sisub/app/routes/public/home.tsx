...
import { Badge, Button, Card, CardContent, CardDescription, CardHeader, CardTitle, Separator } from "@iefa/ui";
...
export function meta() {
    return [{ title: "Previsão SISUB" }, { name: "description", content: "Ajude a melhorar o SISUB" }];
}
...
export default function Home() {
    ...
    return (
        <div className="w-full">
            ...
            {/* Como Funciona */}
            <Appear id="steps" className="py-16 md:py-20" aria-labelledby="steps-heading">
            ...
            {/* Tipos de Refeição */}
            <Appear id="meals" className="py-16 md:py-20" aria-labelledby="meals-heading">
                <div className="text-center mb-14">
                    <Badge variant="outline" className="mx-auto mb-3 gap-2">
                ...
                <div className="text-center mb-6">
                    ...
                    <p className="text-muted-foreground">Marque quais refeições você irá consumir em cada dia</p>
                </div>
            ...
            <Appear id="features" className="py-16 md:py-20" aria-labelledby="features-heading">
                <div className="text-center mb-14">
                    <Badge variant="outline" className="mx-auto mb-3 gap-2">
                        <Star className="h-4 w-4 text-primary" />
                        Funcionalidades
            ...
            <Appear id="cta" className="relative py-20" aria-labelledby="cta-heading">
                <div className="relative text-center max-w-3xl mx-auto rounded-2xl bg-linear-to-r from-primary to-primary/85 text-primary-foreground shadow-lg ring-1 ring-inset ring-border/30 overflow-hidden p-10 px-20">
                    ...
                    <div className="relative">
                        <h2 id="cta-heading" className="text-3xl md:text-4xl font-extrabold tracking-tight mb-4">
                            Pronto para começar?
                        </h2>
                        <p className="text-primary-foreground/85 text-lg mb-8">
                            Faça parte da modernização do SISUB. Acesse agora e comece a planejar suas refeições de
                            forma inteligente.
                        </p>
        ...
        >
            <div className="text-center space-y-6 max-w-4xl mx-auto">
                ...
                <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                    Sistema inteligente para previsão de demanda do rancho. Planeje suas refeições, reduza desperdícios
                    e otimize a gestão alimentar.
                </p>
    ...
    return (
        <Card className="transition-all duration-700">
            <CardHeader className="items-center text-center">
                ...
                <CardDescription className="text-muted-foreground max-w-md mx-auto">{description}</CardDescription>
            </CardHeader>
