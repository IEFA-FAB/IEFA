 ...
 *
 * Uso:
 *   bun run scripts/add-trainees.ts                       # dry-run com a lista padrão
...
const DEFAULT_FILE = "scripts/trainees.txt"
...
async function main() {
	...
	const fromFile = file ? parseRoster(readFileSync(resolve(process.cwd(), file), "utf8")) : []
