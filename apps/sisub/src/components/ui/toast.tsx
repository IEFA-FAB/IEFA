	...
	return (
		<ToastPrimitive.Root
			...
			className={cn(
				...
				"data-[type=success]:border-success/40 data-[type=success]:bg-[color-mix(in_oklab,var(--success)_14%,var(--popover))]",
				"data-[type=warning]:border-warning/40 data-[type=warning]:bg-[color-mix(in_oklab,var(--warning)_14%,var(--popover))]",
				"data-[type=info]:border-info/40 data-[type=info]:bg-[color-mix(in_oklab,var(--info)_14%,var(--popover))]",
