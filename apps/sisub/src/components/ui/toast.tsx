	...
	return (
		<ToastPrimitive.Root
			...
			className={cn(
				...
				"data-[type=success]:border-success/30 data-[type=success]:bg-success/10",
				"data-[type=warning]:border-warning/30 data-[type=warning]:bg-warning/10",
				"data-[type=info]:border-info/30 data-[type=info]:bg-info/10",
