		...
		<SheetPortal>
			...
			<SheetPrimitive.Popup
				...
				className={cn(
					...
					// Teto lateral SEM variante de atributo: com `data-[side=right]:sm:max-w-sm` ele vencia por
					// especificidade o `sm:max-w-xl` de quem usa, e todo painel lateral ficava em 384px. Na mesma
					// variante (`sm:`) o twMerge deixa o `className` de quem usa ganhar.
