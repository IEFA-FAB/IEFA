...
/**
 * Região `aria-live="polite"` do combobox.
 *
 * Não vem no registry do shadcn porque lá todo combobox filtra em memória.
 * Aqui os dois filtram no servidor (CATMAT e tabelas nutricionais), e sem esta
 * região o leitor de tela não anuncia "Buscando…" nem a chegada dos resultados:
