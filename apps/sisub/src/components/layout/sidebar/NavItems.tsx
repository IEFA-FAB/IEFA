...
export const ALL_MODULES: ModuleDef[] = [
	...
	},
	{
		...
		items: [
			...
			{ title: "Exceções", url: "/kitchen/exceptions", icon: Sandwich, group: "Cardápio", keywords: ["café de reunião", "exceção"] },
	...
	},
	{
		...
		items: [
			...
			{ title: "Exceções", url: "/global/exceptions", icon: Sandwich, group: "Modelos de cardápio", keywords: ["exceção modelo"] },
