...
export default function AdminHero({ error }: AdminHeroProps) {
	return (
		<div className="text-center">
			...
			<p className="max-w-2xl mx-auto">Gere o QR de auto check-in e acompanhe indicadores da unidade em tempo real.</p>

			{error && (
				<div className="mt-4 inline-flex items-center gap-2 rounded-lg border px-4 py-2" role="alert">
