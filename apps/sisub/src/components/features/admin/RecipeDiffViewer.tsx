...
export function RecipeDiffViewer({ oldVersion, newVersion }: RecipeDiffViewerProps) {
	...
	const findIngredient = (list: typeof oldVersion.ingredients, productId: string) =>
		...
		<div className="grid grid-cols-2 gap-4">
			...
			<Card className="border-primary">
				...
				<CardContent className="space-y-4">
					<div>
						<span className="text-xs text-muted-foreground">Nome</span>
						<p className={oldVersion.name !== newVersion.name ? "text-primary font-medium" : ""}>
							{newVersion.name}
						</p>
					</div>
					<div>
					...
					<div className="grid grid-cols-2 gap-2">
						<div>
							...
							<p
								className={
									oldVersion.portion_yield !== newVersion.portion_yield ? "text-primary" : ""
								}
							>
						...
						<div>
							...
							<p
								className={
									oldVersion.cooking_factor !== newVersion.cooking_factor ? "text-primary" : ""
								}
							>
