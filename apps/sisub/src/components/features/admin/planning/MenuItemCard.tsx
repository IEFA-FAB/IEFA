...
export function MenuItemCard({
	...
	const [portionQty, setPortionQty] = useState<number | null>(
		item.planned_portion_quantity,
	);
	const [excludedQty, setExcludedQty] = useState<number | null>(
		item.excluded_from_procurement,
	);
	...
	const netQuantity =
		portionQty !== null ? portionQty - (excludedQty || 0) : null;
