			...
			<CardHeader className="pb-3">
				<div className="flex items-center justify-center gap-3">
					<div className="flex flex-col items-end">
						{/* Exception: decorative numeral — intentionally above text-display scale (text-5xl = 3rem vs 1.375rem) */}
					...
					<div className="flex items-center">
						{/* Exception: decorative day abbreviation — intentionally above text-display scale (text-4xl = 2.25rem) */}
