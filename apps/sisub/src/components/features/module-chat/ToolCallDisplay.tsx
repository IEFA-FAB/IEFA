...
const TOOL_LABELS: Record<string, string> = {
	...
	list_atas: "Listando anexos quantitativos",
	get_ata_details: "Consultando anexo quantitativo",
	update_ata_status: "Atualizando status do anexo",
	get_atas: "Listando anexos quantitativos",
