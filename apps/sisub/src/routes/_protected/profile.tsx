...
async function fetchMilitaryDataByNrOrdem(
	nrOrdem: string,
): Promise<MilitaryDataRow | null> {
...
function ProfilePage() {
	...
	const effectiveNrOrdem = useMemo(
		() => userDataQuery.data?.nrOrdem ?? "",
		[userDataQuery.data?.nrOrdem],
	);
		...
		<div className="mx-auto w-full max-w-5xl p-3 sm:p-6">
					...
					<div className="space-y-4">
						{!effectiveNrOrdem ? (
							<div className="text-sm text-muted-foreground">
								Nenhum nrOrdem informado. Preencha seu nrOrdem e salve para
								tentar localizar seus dados militares.
							</div>
						) : isLoadingMilitary ? (
			...
			<div className="rounded-lg border bg-card p-4 sm:p-6">
				...
				<ul className="text-sm text-muted-foreground list-disc pl-5 space-y-1">
					...
					<li>
						Após salvar o nrOrdem, use “Recarregar” para atualizar os dados
						militares.
					</li>
					<li>
						Se seus dados militares não aparecerem, confirme se o nrOrdem está
						correto.
					</li>
				</ul>
			</div>
