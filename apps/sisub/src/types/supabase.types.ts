 ...
 */
export type Views<T extends keyof Database["sisub"]["Views"]> = Database["sisub"]["Views"][T]["Row"]

/**
 * Extrai tipo de Enum do schema sisub
 * @example type KitchenType = Enums<"kitchen_type">
 */
export type Enums<T extends keyof Database["sisub"]["Enums"]> = Database["sisub"]["Enums"][T]
