...
test.describe("Navigation — rotas protegidas", () => {
	test("usuário autenticado acessa /hub sem redirecionamento", async ({ authenticatedPage }) => {
	...
	test("usuário autenticado acessa módulo diner sem redirecionamento", async ({ authenticatedPage }) => {
	...
	test("navegação SPA entre módulos não causa full reload", async ({ authenticatedPage }) => {
