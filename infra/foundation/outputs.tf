...
output "github_tf_apply_role_arn" {
  description = "ARN of the GitHub Actions Terraform apply role (main only). Set as the AWS_TF_APPLY_ROLE_ARN GitHub Actions variable."
  value       = var.enable_github_tf_apply_role ? aws_iam_role.github_tf_apply[0].arn : ""
}
...
output "github_actions_variables" {
  ...
  value = {
    ...
    AWS_TF_APPLY_ROLE_ARN = var.enable_github_tf_apply_role ? aws_iam_role.github_tf_apply[0].arn : ""
