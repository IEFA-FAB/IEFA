-- Cria e preenche o "4º Uniforme C" (Art. 23 do RUMAER), traje de rigor para a Orquestra Sinfônica da
-- Aeronáutica — grupo representacao. Mesma estrutura do 4º "B", com jaquetas de orquestra BRANCAS
-- (em vez de azul-aeronáutica) e casaca de maestro azul-aeronáutica (em vez de branca).
-- Variantes:
...
begin
	...
	where numero = 4 and letra = 'C' and deleted_at is null limit 1;

	if u_id is null then
		insert into rumaer.uniform (numero, letra, nome, grupo, subgrupo, traje, art_referencia, ordem, descricao_md)
		values (4, 'C', '4º Uniforme C', 'representacao', 'rigor', 'rigor', 'Art. 23', 80,
			'4º Uniforme "C", correspondente ao traje de rigor para a Orquestra Sinfônica da Aeronáutica.')
...
with comp(genero, subvar, circulo, slug, nivel, ordem, obs) as (
	values
		-- ===================== FEMININO =====================
		('feminino', null, 'suboficiais', 'jaqueta-feminina-branca-para-orquestra',          'obrigatorio', 0,  'branca, para orquestra'),
		...
		('feminino', null, 'sargentos', 'jaqueta-feminina-branca-para-orquestra',            'obrigatorio', 0,  'branca, para orquestra'),
		...
		-- ===================== MASCULINO =====================
		('masculino', null, 'suboficiais', 'jaqueta-masculina-branca-para-orquestra',        'obrigatorio', 0,  'branca, para orquestra'),
		...
		('masculino', null, 'sargentos', 'jaqueta-masculina-branca-para-orquestra',          'obrigatorio', 0,  'branca, para orquestra'),
		...
		('masculino', null, 'pracas', 'jaqueta-masculina-branca-para-orquestra',             'obrigatorio', 0,  'branca, para orquestra'),
		...
		-- ===================== MAESTRO =====================
		('masculino', 'maestro', 'oficiais', 'casaca-para-maestro',                           'obrigatorio', 0,  'azul-aeronáutica'),
		...
		('masculino', 'maestro', 'suboficiais', 'casaca-para-maestro',                        'obrigatorio', 0,  'azul-aeronáutica'),
...
from comp c
join rumaer.uniform u on u.numero = 4 and u.letra = 'C' and u.deleted_at is null
