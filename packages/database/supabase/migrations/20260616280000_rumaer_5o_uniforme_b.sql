-- Cria e preenche o "5º Uniforme B" (Art. 24 do RUMAER), traje de passeio completo — grupo representacao.
-- Igual ao 5º "A", porém com gorro (em vez de quepe) e inclui o círculo praças.
-- Variantes:
--   feminino  → oficiais, cadetes, suboficiais, sargentos, alunos, praças (cabos e taifeiros)
--   gestante  → oficiais, suboficiais, sargentos, praças (cabos e taifeiros)
--   masculino → oficiais, cadetes, suboficiais, sargentos, alunos, praças (cabos, soldados e taifeiros)
-- Notas: o círculo_hierarquico não separa cabos/soldados/taifeiros → todos em 'pracas'. O friso do gorro
-- (prateado p/ oficiais, cadetes e alunos exceto EPCAR/CPORAER-SJ; azul-royal p/ suboficiais) vai na observação.
...
begin
	...
	where numero = 5 and letra = 'B' and deleted_at is null limit 1;

	if u_id is null then
		insert into rumaer.uniform (numero, letra, nome, grupo, subgrupo, traje, art_referencia, ordem, descricao_md)
		values (5, 'B', '5º Uniforme B', 'representacao', 'passeio', 'passeio completo', 'Art. 24', 100,
			'5º Uniforme "B", correspondente ao traje de passeio completo (com gorro).')
...
with comp(genero, subvar, circulo, slug, nivel, ordem, obs) as (
	values
		...
		('feminino', null, 'sargentos', 'tunica-feminina-azul-aeronautica',            'obrigatorio', 1,  'azul-aeronáutica (sargentos, alunas da EEAR, cabos e taifeiros)'),
		...
		('feminino', null, 'pracas', 'tunica-feminina-azul-aeronautica',               'obrigatorio', 1,  'azul-aeronáutica (sargentos, alunas da EEAR, cabos e taifeiros)'),
		('feminino', null, 'pracas', 'camisa-feminina-azul-clara-de-mangas-compridas', 'obrigatorio', 2,  null),
		('feminino', null, 'pracas', 'gravata-feminina-preta',                         'obrigatorio', 3,  null),
		('feminino', null, 'pracas', 'calca-feminina-azul-aeronautica',                'obrigatorio', 4,  'calça ou saia, azul-aeronáutica'),
		('feminino', null, 'pracas', 'saia-azul-aeronautica',                          'obrigatorio', 5,  'calça ou saia, azul-aeronáutica'),
		('feminino', null, 'pracas', 'cinto-azul-aeronautica-branco-ou-preto',         'obrigatorio', 6,  'azul-aeronáutica, com fivela prateada'),
		('feminino', null, 'pracas', 'sapato-feminino-de-salto-medio-tipo-2',          'obrigatorio', 7,  'preto, salto médio'),
		('feminino', null, 'pracas', 'meia-calca-social-lisa',                         'obrigatorio', 8,  'cor da pele (quando usando saia)'),
		('feminino', null, 'pracas', 'meia-preta-branca-de-nylon',                     'obrigatorio', 9,  'preta (quando usando calça)'),
		('feminino', null, 'pracas', 'camisa-branca-flanelada-de-mangas-compridas-2-pele','facultativo', 12, '2ª pele branca'),
		('feminino', null, 'pracas', 'colete-azul-aeronautica-com-gola-em-v',          'facultativo', 13, 'gola em "V"'),
		('feminino', null, 'pracas', 'capa-de-chuva-azul-aeronautica',                 'facultativo', 14, 'azul-aeronáutica'),
		('feminino', null, 'pracas', 'sobretudo-feminino-azul-aeronautica',            'facultativo', 15, 'azul-aeronáutica'),
		('feminino', null, 'pracas', 'cachecol-branco',                                'facultativo', 16, null),
		('feminino', null, 'pracas', 'luva-preta-de-couro',                            'eventual',    20, null),
		...
		('feminino', 'gestante', 'pracas', 'camisa-feminina-azul-clara-de-mangas-compridas','obrigatorio', 2,  'ou bata azul-clara'),
		('feminino', 'gestante', 'pracas', 'gravata-feminina-preta',                   'obrigatorio', 3,  null),
		('feminino', 'gestante', 'pracas', 'sapato-feminino-de-salto-medio-tipo-2',    'obrigatorio', 4,  'preto (salto médio, baixo ou sem salto)'),
		('feminino', 'gestante', 'pracas', 'meia-calca-social-lisa',                   'obrigatorio', 5,  'cor da pele (autorizado uso de meia especial)'),
		('feminino', 'gestante', 'pracas', 'camisa-branca-flanelada-de-mangas-compridas-2-pele','facultativo', 12, '2ª pele branca'),
		('feminino', 'gestante', 'pracas', 'colete-azul-aeronautica-com-gola-em-v',    'facultativo', 13, 'gola em "V"'),
		('feminino', 'gestante', 'pracas', 'capa-de-chuva-azul-aeronautica',           'facultativo', 14, 'azul-aeronáutica'),
		('feminino', 'gestante', 'pracas', 'sobretudo-feminino-azul-aeronautica',      'facultativo', 15, 'azul-aeronáutica'),
		('feminino', 'gestante', 'pracas', 'cachecol-branco',                          'facultativo', 16, null),
		('feminino', 'gestante', 'pracas', 'luva-preta-de-couro',                      'eventual',    20, null),
		...
		('masculino', null, 'sargentos', 'tunica-masculina-azul-aeronautica',          'obrigatorio', 1,  'azul-aeronáutica (sargentos, alunos da EEAR, cabos, soldados e taifeiros)'),
		...
		('masculino', null, 'pracas', 'tunica-masculina-azul-aeronautica',             'obrigatorio', 1,  'azul-aeronáutica (sargentos, alunos da EEAR, cabos, soldados e taifeiros)'),
		('masculino', null, 'pracas', 'camisa-masculina-azul-clara-de-mangas-compridas','obrigatorio', 2,  null),
		('masculino', null, 'pracas', 'gravata-vertical-preta',                        'obrigatorio', 3,  'vertical'),
		('masculino', null, 'pracas', 'calca-masculina-azul-aeronautica',              'obrigatorio', 4,  null),
		...
		('masculino', null, 'pracas', 'camisa-branca-flanelada-de-mangas-compridas-2-pele','facultativo', 12, '2ª pele branca'),
		('masculino', null, 'pracas', 'colete-azul-aeronautica-com-gola-em-v',         'facultativo', 13, 'gola em "V"'),
		('masculino', null, 'pracas', 'capa-de-chuva-azul-aeronautica',                'facultativo', 14, 'azul-aeronáutica'),
		('masculino', null, 'pracas', 'sobretudo-masculino-azul-aeronautica',          'facultativo', 15, 'azul-aeronáutica'),
		('masculino', null, 'pracas', 'cachecol-branco',                               'facultativo', 16, null),
		('masculino', null, 'pracas', 'luva-preta-de-couro',                           'eventual',    20, null),
...
from comp c
join rumaer.uniform u on u.numero = 5 and u.letra = 'B' and u.deleted_at is null
