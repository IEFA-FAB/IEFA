...
-- ----------------------------------------------------------------------------
-- A ordem FEFO de `register_production_issue` NÃO é corrigida aqui
-- ----------------------------------------------------------------------------
-- Uma versão anterior desta migration recriava a função com a ordem nova. Era
-- redundante e perigoso: o conserto definitivo está na 20260918160000, de
-- carimbo MAIOR, e reescrever a mesma função aqui significa aplicar a ordem
-- ANTIGA depois — num banco limpo o `db push` passa por este arquivo primeiro,
-- e o resultado final só ficava certo por acidente da ordem alfabética.
-- Uma função, um lugar.
