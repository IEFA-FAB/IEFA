...
| `weekly-menus-new-draft-<cozinha>`, `events-new-draft-<cozinha>`, `exceptions-new-draft-<cozinha>` | armazenamento de sessão | SISUB | fim da aba, ou até o cardápio ser criado | rascunho do nome e da descrição do cardápio que está sendo criado e, nos apoios (lanches de bordo e de apoio, coffee breaks), das ocorrências mensais |
