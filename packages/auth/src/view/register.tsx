...
import { AlertCircle, Check, CheckCircle, Eye, EyeOff, Loader2, Lock, Mail, X } from "lucide-react";
...
export function Register() {
    ...
    }, [formData.email, formData.password, formData.confirmPassword, fieldErrors]);
    ...
    return (
        <Card className="w-full max-w-md mx-auto">
            <CardHeader className="space-y-1">
                ...
                <CardDescription className="text-center">Acesso restrito a emails @fab.mil.br</CardDescription>
            </CardHeader>
